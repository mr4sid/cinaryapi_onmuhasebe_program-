...
class App(ThemedTk):
    ...
    def stok_yonetimi_goster(self): self.notebook.select(self.stok_yonetimi_sayfasi),self.after_idle(lambda: self.stok_yonetimi_sayfasi.arama_entry.focus_set())
    def musteri_yonetimi_goster(self): self.notebook.select(self.musteri_yonetimi_sayfasi),self.after_idle(lambda: self.musteri_yonetimi_sayfasi.arama_entry.focus_set())
    def tedarikci_yonetimi_goster(self): self.notebook.select(self.tedarikci_yonetimi_sayfasi),self.after_idle(lambda: self.tedarikci_yonetimi_sayfasi.arama_entry.focus_set())
